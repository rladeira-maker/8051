                                     ...
                                     10 ;--------------------------------------------------------
                                     11 	.globl _main
                                     12 	.globl _iic_single_byte_write
                                     13 	.globl _delay_ms
                                     14 	.globl _CY
                                     15 	.globl _AC
                                     16 	.globl _F0
      ...
      000062                        316 _main:
                           ...
                           000001   323 	ar1 = 0x01
                           000000   324 	ar0 = 0x00
                                    325 ;	main.c:9: while(1)
      000062                        326 00102$:
                                    327 ;	main.c:11: P1_2 = 0;
                                    328 ;	assignBit
      000062 C2 92            [12]  329 	clr	_P1_2
                                    330 ;	main.c:13: a = iic_single_byte_write(0x4e, 0xff, 0xff);
      000064 75 0C FF         [24]  331 	mov	_iic_single_byte_write_PARM_2,#0xff
      000067 75 0D FF         [24]  332 	mov	_iic_single_byte_write_PARM_3,#0xff
      00006A 75 82 4E         [24]  333 	mov	dpl,#0x4e
      00006D 12 01 C6         [24]  334 	lcall	_iic_single_byte_write
                                    335 ;	main.c:14: delay_ms(500);
      000070 90 01 F4         [24]  336 	mov	dptr,#0x01f4
      000073 12 00 8C         [24]  337 	lcall	_delay_ms
                                    338 ;	main.c:16: P1_2 = 1;
                                    339 ;	assignBit
      000076 D2 92            [12]  340 	setb	_P1_2
                                    341 ;	main.c:18: a = iic_single_byte_write(0x4e, 0x00, 0x00);
      000078 75 0C 00         [24]  342 	mov	_iic_single_byte_write_PARM_2,#0x00
      00007B 75 0D 00         [24]  343 	mov	_iic_single_byte_write_PARM_3,#0x00
      00007E 75 82 4E         [24]  344 	mov	dpl,#0x4e
      000081 12 01 C6         [24]  345 	lcall	_iic_single_byte_write
                                    346 ;	main.c:19: delay_ms(250);	  
      000084 90 00 FA         [24]  347 	mov	dptr,#0x00fa
      000087 12 00 8C         [24]  348 	lcall	_delay_ms
                                    349 ;	main.c:22: }
      00008A 80 D6            [24]  350 	sjmp	00102$
                                    351 	.area CSEG    (CODE)
                                    352 	.area CONST   (CODE)
                                    353 	.area XINIT   (CODE)
