...
;------------------------------------------------------------
;	iic_c.c:50: unsigned char I2CSend(unsigned char Data)
;	-----------------------------------------
;	 function I2CSend
;	-----------------------------------------
_I2CSend:
	mov	r7,dpl
;	iic_c.c:53: for (i = 0; i < 8; i++) {
	mov	r6,#0x00
00105$:
;	iic_c.c:54: if ((Data & 0x80) == 0)
	mov	a,r7
	jb	acc.7,00102$
;	iic_c.c:55: SDA = 0;
;	assignBit
...
;Data                      Allocated to registers r7 
;------------------------------------------------------------
;	iic_c.c:69: unsigned char I2CRead()
;	-----------------------------------------
;	 function I2CRead
;	-----------------------------------------
_I2CRead:
;	iic_c.c:71: unsigned char i, Data=0;
	mov	r7,#0x00
;	iic_c.c:72: for (i = 0; i < 8; i++) {
	mov	r6,#0x00
00106$:
;	iic_c.c:73: SCL = 1;
;	assignBit
